	...
	public class SWDGradingDbContext : DbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Exam>(entity =>
			{
				...
				entity.Property(e => e.DriveImagesFolderId)
					  .HasMaxLength(255);

				entity.Property(e => e.DriveSolutionsFolderId)
					  .HasMaxLength(255);

				entity.Property(e => e.DriveOriginalExcelFileId)
					  .HasMaxLength(255);
			});
			...
			modelBuilder.Entity<ExamZip>(entity =>
			{
				...
				entity.Property(e => e.DriveZipFileId)
					  .HasMaxLength(255);

				entity.Property(e => e.DriveZipWebViewLink)
					  .HasMaxLength(500);
			...
			modelBuilder.Entity<DocFile>(entity =>
			{
				...
				entity.Property(e => e.DriveWebViewLink)
					  .HasMaxLength(500);
			...
			modelBuilder.Entity<GradeExport>(entity =>
			{
				...
				entity.Property(x => x.DriveWebViewLink)
					.HasMaxLength(500);
